...
class TestBot(sc2.BotAI):
	...
	async def offensive_force_building(self):
		print("clock: ", self.iteration/self.ITERATIONS_PER_MINUTE)
...
run_game(maps.get("AbyssalReefLE"), [Bot(Race.Protoss, TestBot()), Computer(Race.Terran, Difficulty.Easy)], realtime=False)
